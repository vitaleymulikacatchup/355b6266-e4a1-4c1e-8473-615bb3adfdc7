...
export const metadata: Metadata = {
  title: "Fanatastika | Premium T-Shirts with Unique Designs",
  description: "Discover unique, high-quality t-shirts at Fanatastika. Express your style with exclusive designs, premium materials, and fast shipping. Shop our collection now!",
  keywords: "t-shirts, graphic tees, casual wear, apparel, fashion, organic cotton, unique designs",
  openGraph: {
    title: "Fanatastika | Premium T-Shirts",
    description: "Express your style with Fanatastika's unique collection of high-quality t-shirts",
    type: "website",
    siteName: "Fanatastika",
  },
  twitter: {
    card: "summary_large_image",
    title: "Fanatastika | Premium T-Shirts",
    description: "Unique, high-quality t-shirts for those who dare to express themselves",
  },
  robots: {
    index: true,
    follow: true,
